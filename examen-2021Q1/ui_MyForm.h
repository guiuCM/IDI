...
public:
    ...
    void setupUi(QWidget *MyForm)
    {
        ...
        QObject::connect(checkBox, SIGNAL(clicked(bool)), widget, SLOT(canviCamera()));
        QObject::connect(widget, SIGNAL(canviCam2(bool)), checkBox, SLOT(setChecked(bool)));
        QObject::connect(widget, SIGNAL(resP(int)), spinBox, SLOT(setValue(int)));
    ...
    void retranslateUi(QWidget *MyForm)
    {
        ...
        checkBox->setText(QCoreApplication::translate("MyForm", "canviCamera", nullptr));
